 package cn.libins{
	...
	public class StringUtil{
		...
		public static function  toPoint(str:String):Point {
	         var indexStr1:String = "(x=";
	         var indexStr2:String = "y=";
	         var tempArr:Array =str.split(",");
	         var str1:String = tempArr[0];
	         var myX:Number = Number(str1.substring(str1.indexOf(indexStr1)+indexStr1.length));
	         var str2:String = tempArr[1];
	         var myY:Number = Number(str2.substring(str2.indexOf(indexStr2)+indexStr2.length,str2.length-1));
	         return new Point(myX,myY);
        }
		//url地址的随机数
		public static function randomURL(str:String):String{
			return str+"?random="+Math.floor(Math.random()*1000);
		}
	}
}